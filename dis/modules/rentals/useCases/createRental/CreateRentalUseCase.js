...
let CreateRentalUseCase = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    const rentalOpenToUser = await this.rentalRepository.findByOpenRentalByUser(user_id);
    ...
    const compare = this.dateProvider.compareInHours(dateNow, expected_return_date); // ok Format date
