...
var _CategoriesRepositoryInMemory = require("../../repository/in-memory/CategoriesRepositoryInMemory");
...
describe('Create Category', () => {
  ...
  it('should be able to create a new category', async () => {
    ...
    expect(categoryCreated).toHaveProperty('id'); // testando se tem a propriedade id
  });
  it('should not be able to create a new category with name exists', async () => {
    ...
    await expect(createCategoryUseCase.execute({
      name: category.name,
      description: category.description
    })).rejects.toEqual(new _AppError.AppError('Category Alrealy exists!')); // se vier a instancia erro
  });
});