...
var _DevolutionRentalController = require("../../../../modules/rentals/useCases/devolutionRentalUseCase/DevolutionRentalController");
...
const listRentalsByUser = new _ListRentalsByUserController.ListRentalsByUserController();
...
rentalRoutes.get('/user', _ensureAuthenticated.ensureAuthenticated, listRentalsByUser.handle);